    ...
    <div key={id}>
      <div className='flex items-start'>
        ...
        <div className={`${s.answerWrap}`}>
          <div className={`${s.answer} relative text-xxs text-gray-900`}>
            <div className={`ml-2 py-3 px-4 bg-gray-100 rounded-tr-2xl rounded-b-2xl ${workflowProcess && 'min-w-[240px]'}`}>
              {showWorkflow && workflowProcess && (
